...
const Homepage = () => {
  return (
    <div className="lg:flex items-center justify-between lg:mx-52 w-screen">
      ...
      <div className="relative lg:block hidden">
        ...
        <div className="border-main-green border h-[30rem] w-[30rem] bg-gradient-to-br from-[#175553] via-[#154d4b] to-transparent p-10 rounded-lg">
          test
        </div>
      </div>
    </div>
